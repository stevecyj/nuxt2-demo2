<template>
  <div>
    ...
    >
      <div class="flex relative flex-col justify-end px-6 mt-80 w-full">
        <div class="text-left">2024/01/31 FRI</div>
        <h2 class="mt-2.5 text-2xl font-semibold tracking-tight leading-7">
          語言共舞：跨足多國文化之旅
        </h2>
