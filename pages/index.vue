...
-->
  <div
    class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-slate-100 py-6 sm:py-12"
  >
    <div class="min-h-28">
          ...
          <div class="bg-white w-1/3 shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6">
              ...
              <h3 class="mt-3 font-bold text-lg pb-4 border-b border-slate-300">
                <a
                  href="https://play.tailwindcss.com/TGny89rOkl?layout=horizontal"
                >
